...
vim.keymap.set('n', '<leader>ha', function() ui.nav_file(5) end)
vim.keymap.set('n', '<leader>hs', function() ui.nav_file(6) end)
vim.keymap.set('n', '<leader>hd', function() ui.nav_file(7) end)
vim.keymap.set('n', '<leader>hf', function() ui.nav_file(8) end)
